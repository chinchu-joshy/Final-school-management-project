...
var ffprobe_1 = require("@ffprobe-installer/ffprobe");
var execa = require("execa");
var isStream = require("is-stream");
function getFFprobeWrappedExecution(input) {
    var params = ['-v', 'error', '-show_format', '-show_streams'];
    if (typeof input === 'string') {
        return execa(ffprobe_1.path, __spreadArrays(params, [input]));
    }
    if (isStream(input)) {
        return execa(ffprobe_1.path, __spreadArrays(params, ['-i', 'pipe:0']), {
            reject: false,
            input: input,
        });
    }
...
function getVideoDurationInSeconds(input) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getFFprobeWrappedExecution(input)];
                case 1:
